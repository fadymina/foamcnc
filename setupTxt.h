...
enum { _NO_BUTTON = 0 , _SETUP , _PRINT , _HOME, _UNLOCK , _RESET , _SD , _USB_GRBL , _TELNET_GRBL, _PAUSE ,
    ...
    _ZP , _ZM, _AP, _AM, _D_AUTO , _D100, _D10 ,  _D1, _D0_1 ,  _D0_01 ,
    _SET_WCS , _SETX , _SETY , _SETZ, _SETA , _SETXYZ , _SETXYZA ,_SET_CHANGE,  _SET_PROBE, _SET_CAL ,
    _GO_CHANGE, _GO_PROBE , _TOOL , _BACK , _LEFT, _RIGHT , _UP , _CMD1 ,_CMD2 ,_CMD3 ,
    _CMD4 , _CMD5 ,_CMD6 ,_CMD7 , _CMD8 , _CMD9 , _CMD10 , _CMD11 , _MORE_PAUSE , _FILE0 , 
    _FILE1 , _FILE2 , _FILE3 , _MASKED1 , _PG_PREV , _PG_NEXT, _SD_SHOW ,  _OVERWRITE, _OVER_SWITCH_TO_FEEDRATE , _OVER_SWITCH_TO_SPINDLE,
    _OVER_100 , _OVER_10P, _OVER_10M,_OVER_1P, _OVER_1M, _TOOGLE_SPINDLE, _COMMUNICATION , _SERIAL , _BLUETOOTH , _TELNET ,
    _SD_GRBL, _FILE0_GRBL , _FILE1_GRBL , _FILE2_GRBL , _FILE3_GRBL , _YES_BTN, _NO_BTN , _LOG ,
    _YAP ,_XZP ,_YAM ,_XZM ,_POS_INI , _MAX_BTN} ; // keep _MAX_BTN latest
...
enum { _P_NULL = 0  , _P_INFO , _P_SETUP , _P_PRINT , _P_PAUSE , _P_MOVE , _P_SETXYZ , _P_SD , _P_CMD , _P_LOG , _P_TOOL, 
      ...
      _P_MOVET , _P_MAX_PAGES} ; // keep _P_MAX_PAGE latest
...
enum { _WPOS = 0, _MPOS , _FEED , _RPM , _TOUCH_CORNER , 
    ...
    _TRY_TO_CONNECT_WITH_TELNET, _WIFI_CONNECTED , _CONFIRM_SD_FILE , 
