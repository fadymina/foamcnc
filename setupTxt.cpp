...
mButton[_POS_INI].pLabel = __posIni ;

mButton[_XZP].pLabel = "Frente" ;
mButton[_XZM].pLabel = "Atras" ;
mButton[_YAP].pLabel = "Cima" ;
mButton[_YAM].pLabel = "Baixo" ;
...
mButton[_SET_CAL].pIcon = setCalIcon  ;
mButton[_GO_CHANGE].pIcon = GoChangeIcon ; 
mButton[_GO_PROBE].pIcon = GoProbeIcon ;
...
fillMPage (_P_SETUP , 4 , _UNLOCK , _JUST_PRESSED , fUnlock , 0) ;
//fillMPage (_P_SETUP , 3 , _OVERWRITE , _JUST_PRESSED , fGoToPage , _P_OVERWRITE ) ; 
fillMPage (_P_SETUP , 5 , _HOME , _JUST_PRESSED , fHome , 0) ;
...
fillMPage (_P_SETUP , 8 , _SET_WCS , _JUST_PRESSED , fGoToPage , _P_MOVE ) ;
...
fillMPage (_P_SETUP , 9 , _INFO , _JUST_PRESSED , fGoToPageAndClearMsg ,  _P_INFO) ;
fillMPage (_P_SETUP , 10 , _POS_INI , _JUST_PRESSED , posIni , 0 ) ;
fillMPage (_P_SETUP , 11 , _TOOL , _JUST_PRESSED , fGoToPage , _P_MOVET ) ;


mPages[_P_MOVET].titel = "Move torres" ;
mPages[_P_MOVET].pfBase = fMoveBase ;
#ifdef AA_AXIS
  fillMPage (_P_MOVET , 1 , _YAP , _JUST_LONG_PRESSED_RELEASED , fMoveT , _YAP) ;
  fillMPage (_P_MOVET , 2 , _XZP , _JUST_LONG_PRESSED_RELEASED , fMoveT , _XZP) ;
  fillMPage (_P_MOVET , 5 , _YAM , _JUST_LONG_PRESSED_RELEASED , fMoveT , _YAM) ;
  fillMPage (_P_MOVET , 6 , _XZM , _JUST_LONG_PRESSED_RELEASED , fMoveT , _XZM) ;
  // fillMPage (_P_MOVET , 3 , _XZM , _JUST_LONG_PRESSED_RELEASED , fMoveT , _XZM) ;
  // fillMPage (_P_MOVET , 3 , _USB_GRBL , _JUST_PRESSED , ligaFio , 0) ;
  // fillMPage (_P_MOVET , 7 , _TELNET_GRBL , _JUST_PRESSED , desligaFio , 0) ;


#else
  fillMPage (_P_MOVET , 1 , _YP , _JUST_LONG_PRESSED_RELEASED , fMoveT , _YP) ;
  fillMPage (_P_MOVET , 3 , _ZP , _JUST_LONG_PRESSED_RELEASED , fMoveT , _ZP) ;
  fillMPage (_P_MOVET , 5 , _YM , _JUST_LONG_PRESSED_RELEASED , fMoveT , _YM) ;
  fillMPage (_P_MOVET , 7 , _ZM , _JUST_LONG_PRESSED_RELEASED , fMoveT , _ZM) ;
  fillMPage (_P_MOVET , 8 , _XM , _JUST_LONG_PRESSED_RELEASED , fMoveT , _XM) ;
  fillMPage (_P_MOVET , 10 , _XP , _JUST_LONG_PRESSED_RELEASED , fMoveT , _XP) ;
#endif
  fillMPage (_P_MOVET , POS_OF_MOVE_D_AUTO , _D_AUTO , _JUST_PRESSED , fDist, _D_AUTO) ;  // -1 because range here is 0...11
  fillMPage (_P_MOVET , 11 , _BACK , _JUST_PRESSED , fGoBack , 0) ;
...
fillMPage (_P_PRINT , 6 , _SETUP , _JUST_PRESSED , fGoToPage , _P_SETUP) ;
...
fillMPage (_P_MOVE , 0 , _AM , _JUST_LONG_PRESSED_RELEASED , fMove , _AM) ;
fillMPage (_P_MOVE , 9 , _YM , _JUST_LONG_PRESSED_RELEASED , fMove , _YM) ;
fillMPage (_P_MOVE , 2 , _AP , _JUST_LONG_PRESSED_RELEASED , fMove , _AP) ;
...
#endif
fillMPage (_P_MOVE , 5 , _D_AUTO , _JUST_PRESSED , fDist, _D_AUTO) ;  // -1 because range here is 0...11 
