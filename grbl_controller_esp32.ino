...
//  if (newGrblStatusReceived) Serial.println( "newStatus");
  ...
  if (newGrblStatusReceived == true) {
    ...
    if ( currentPage == _P_INFO ||  currentPage == _P_SETXYZ || currentPage == _P_SETUP || currentPage == _P_TOOL 
  ...
  if (lastMsgChanged == true && ( currentPage == _P_INFO || currentPage == _P_SETXYZ || currentPage == _P_SETUP 
